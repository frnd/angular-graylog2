(function() {
  ...
  var module = angular.module('angular-gaylog2', []);
  ...
  module.provider('Graylog2', function() {
    ...
    this.$get = ['$http', function($http) {
      ...
      instance.log = function(level, message, data) {
        ...
        delete logData._id;
        return $http.put(options.uri, logData);
      };

      var methods = ['debug', 'info', 'warn', 'error', 'fatal'];
      methods.forEach(function(method, index) {
        instance[method] = function() {
          return instance.log.apply(instance.log, [index].concat(arguments));
        };
      });
